...
import { Moon, Sun, Monitor, Bell, BellOff, LogOut, Shield, Trash2 } from "lucide-react";
...
export default function LandlordSettingsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-2xl">
      ...
      {/* Account Actions */}
      <div className="p-5 rounded-xl bg-surface-container-lowest border border-surface-variant card-elevation-1 space-y-3">
